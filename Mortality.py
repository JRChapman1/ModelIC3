...
class Mortality:
    ...
    def prob_death(self):
        ...
        # Multiply the probability inforce at each time by the probability of dying during that time-step and return the
        # result
        return df_qx * df_prob_in_force
